...
const HomePage=()=>{
    return(
        ...
        <Header />
        <section>
            <h1 className="text-dark-blue font-semibold sm:my-16 sm:text-center tracking-wide lg:absolute lg:left-24 lg:top-72 text-6xl">Data Science Union</h1>
            <h1 className="text-gray-black tracking-wide sm:my-16 sm:text-center lg:absolute lg:left-24 lg:top-96 text-6xl">UCLA</h1>
        ...
        <section className="flex flex-col sm:items-center lg:flex-row sm:gap-y-32 lg:mx-32">
            <div className="flex flex-col basis-1/2 sm:gap-y-24 lg:gap-y-32">
            ...
            <div className="relative justify-center">
                <p className="absolute sm:top-20 lg:top-16 sm:left-40 lg:left-36 text-3xl tracking-widest font-medium leading-4 text-dark-blue text-center">Language and Software</p>
                <p className="absolute sm:top-32 lg:top-28 sm:left-16 lg:left-6 text-gray-black text-xl text-center LandSoftwareText">
        ...
        <section className="flex flex-row my-32">
            ...
            <div className="flex flex-col ml-12 gap-y-12 justify-center">
                ...
                <p className="text-gray-blue joiningText text-lg">
