...
const HomePage=()=>{
    return(
        ...
        <Header />
        <section>
            <h1 className="text-dark-blue font-semibold sm:my-16 text-center xl:text-left tracking-wide xl:absolute xl:left-24 xl:top-72 text-3xl xl:text-6xl">Data Science Union</h1>
            <h1 className="text-gray-black tracking-wide sm:my-16 text-center xl:text-left xl:absolute xl:left-24 xl:top-96 text-3xl xl:text-6xl">UCLA</h1>
            <img src={HomePageGraphic} alt="Graphics" className="w-full"/>
        </section>
        <section className="flex flex-col text-center md:mx-64 gap-y-4 mb-32">
            <p className="text-dark-blue font-semibold tracking-wide mt-24 text-3xl xl:text-5xl">Who We Are</p>
        ...
        <section className="flex flex-col items-center xl:items-start xl:flex-row gap-y-32 xl:mx-32">
            <div className="flex flex-col basis-1/2 sm:gap-y-24 gap-y-12 xl:gap-y-32">
            ...
            <div className="relative justify-center">
                <p className="absolute sm:top-20 xl:top-16 left-20 top-12 sm:left-40 xl:left-36 text-xl sm:text-3xl tracking-widest font-medium leading-4 text-dark-blue text-center">Language and Software</p>
                <p className="absolute sm:top-32 xl:top-28 top-20 left-4 sm:left-16 xl:left-6 text-gray-black text-sm sm:text-xl text-center LandSoftwareText">
        ...
        <section className="flex flex-row my-32">
            ...
            <div className="flex flex-col ml-12 gap-y-12 justify-center">
                <p className="text-dark-blue text-3xl sm:text-5xl tracking-wide font-medium">We are moving online!</p>
